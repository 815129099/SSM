...
type:"POST",
data:{positionType:a,positionName:b,department:c,
jobNature:d,salaryMin:e,salaryMax:f,workAddress:g,
workYear:h,education:i,positionAdvantage:j,positionDetail:k,
positionAddress:l,positionLng:m,positionLat:n,email:o,
forwardEmail:p,id:q,companyId:r,resubmitToken:s},
...
$("#box_job .job_main").each(function(){
$(this).children("li").each(function(a){1==a%3?$(this).children(".job_sub").css({marginLeft:"-160px"}):2==a%3&&$(this).children(".job_sub").css({marginLeft:"-310px"})})}),
...
type:"POST",
url:"comJob",
data:{email:email,jobType:a,jobName:b,department:c,number:d,deRequest:e,detail:f,salary:g,time:h},
dataType:"json",
success:function(response){
if(response.tip==false){
$("#create").addClass("dn");
$("#createSu").removeClass("dn");
$("#createSu #showTip").html("很遗憾，发布失败！");
$("#kkk").show();
$("#positionType").attr("readOnly","false");
$("#positionName").attr("readOnly","false");
}
else{
$("#create").addClass("dn");
$("#createSu").removeClass("dn");
$("#createSu #showTip").html("恭喜你，发布成功！");
$("#kkk").show();
$("#positionType").attr("readOnly","false");
$("#positionName").attr("readOnly","false");
};
