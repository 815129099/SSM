...
case"workExperience":$("#workExperience .experienceAdd").trigger("click");break;case"projectExperience":$("#projectExperience .projectAdd").trigger("click");break;case"educationalBackground":$("#educationalBackground .educationalAdd").trigger("click");break;
case"selfDescription":$("#selfDescription .descriptionAdd").trigger("click");break;case"worksShow":$("#worksShow .workAdd").trigger("click");break;
default:return}
...
l=$("#resubmitToken").val();
$(a).find(":submit").val("保存中...").attr("disabled",true),
$.ajax({
type:"POST",
url:"comBasicInfo",
...
$("#showWe").html("体重："+e);
$("#showPhone").html("手机："+h);
$(a).find(":submit").val("保存中...").attr("disabled",false);
}
}
});
}}),
...
$("#expectForm .btn_profile_cancel").bind("click",function(){b.Cancel()}),
...
a.stopPropagation();var b=$(this).text();selectYear("schoolYearStart",b),$(this).parents(".educationalForm").validate().element($(".schoolYearStart"))}),
...
dataType:"json",
success:function(response){
$(".educationalShow").children(".educationalForm").hide();
