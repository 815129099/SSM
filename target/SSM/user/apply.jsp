...
<div id="body">
    ...
    <%if(session.getAttribute("type")!=null & session.getAttribute("type")!=""){%>
    		<%if(session.getAttribute("type").equals("company")){%>
                <li ><a href="comIndex.jsp" rel="nofollow">公司主页</a></li>
                <li ><a href="create.jsp" rel="nofollow">兼职</a></li>
            <%} else if(session.getAttribute("type").equals("student")){%>
                <li ><a href="delivery.jsp" rel="nofollow">报名</a></li>
                <li ><a href="stuResume.jsp" rel="nofollow">简历</a></li>
            ...
            <%}}%>
                ...
                <dd style="display: none;"><a href="updatePwd.jsp">帐号设置</a></dd>
...
<%if(session.getAttribute("type")!=null & session.getAttribute("type")!=""){%>
    ...
    <dd class="resume resume_web">
				                        <div>
								          <span> 你已有可投递的在线简历：<a target="_blank" href="preview?email=${sessionScope.email}"><strong id="stuName"></strong></a></span><br>
								          <span id="upTime"></span>
				                        </div>
				                        <span class="setBtns">
