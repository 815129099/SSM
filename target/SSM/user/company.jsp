...
$(document).ready(function(){
    if(email!=null&&email!=""){
        ...
        if(type!="noCom"){window.location.href = 'index.jsp';}
 ...
 function checkCompany(){
        if(type!="company"){
            ...
            window.location.href = 'comIndex.jsp';
        }
   }
</script>
	...
	<div id="header">
    	<div class="wrapper">
    		...
    		<ul id="navheader" class="reset">
    			...
    			<li class="current"><a href="company.jsp">完善信息</a></li>
...
<script src="./style/js/step6.min.js" type="text/javascript"></script>
<script>
         var avatar = {};
