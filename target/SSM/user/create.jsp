...
if(email!=null&&email!=""){}
    ...
    if(type!="company"){window.location.href = 'index.jsp';}
    disResume();
    disApply();
	...
	<div id="header">
    	<div class="wrapper">
    		...
    		<ul id="navheader" class="reset">
    			...
    			<li><a href="comIndex.jsp">公司</a></li>
    			<li ><a href="index.jsp" rel="nofollow">学生版</a></li>
        	...
        	<dl class="collapsible_menu">
            	<dt style="height:30px;line-height:30px;">
                    ...
                    <dd style="display: none;"><a href="create.jsp">我发布的职位</a></dd>
                	<dd style="display: none;"><a href="create.jsp">我收到的简历</a></dd>
...
<dl class="company_center_aside">
		...
		<dd><a  onclick="myAllege()">我的申述</a></dd>
         ...
         <a onclick="lookRe()">查看兼职</a><br><a class="greylink" onclick="create()">发布新兼职</a><br>
          <a class="greylink" href="comIndex.jsp"> 进入我的公司主页</a><br>
