...
if(email!=null&&email!=""){
    ...
    window.location.href = 'login.jsp';
        ...
        if(type!="student"){window.location.href = 'index.jsp';}
       $.ajax({
        type:"post",
        data:{"email":email},
        url:'showRecord',
	...
	<div id="header">
    	<div class="wrapper">
    		...
    		<ul id="navheader" class="reset">
    			...
    			<li><a href="index.jsp">职位</a></li>
    			<li class="current"><a rel="nofollow" href="stuResume.jsp">我的简历</a></li>
        	...
        	<dl class="collapsible_menu">
            	<dt>
            		...
            		<i></i>
                                	...
                                	<dd style="display: none;"><a rel="nofollow" href="stuResume.jsp">修改简历</a></dd>
                	                	<dd style="display: none;"><a href="delivery.jsp">我投递的兼职 <span id="noticeNo" class="red dn">(0)</span></a></dd>
                	                	<dd class="btm" style="display: none;"><a target="_blank" href="preview?email=${sessionScope.email}">预览简历</a></dd>
                	                    <dd style="display: none;"><a href="index.jsp">职位</a></dd>
                                        <dd style="display: none;"><a href="updatePwd.jsp">密码修改</a></dd>
  		...
  		<div class="clearfix">
            ...
            <div class="content_r">
            	<div class="mycenterR" id="myInfo">
            		...
            		<a target="_blank" href="delivery.jsp">查看更多</a>
