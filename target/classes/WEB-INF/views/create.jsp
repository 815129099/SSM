    ...
    var ht = '',ht1='',ht2='',ht3='';
        var xx1=0,xx2=0,xx3=0;
            $.ajax({
                    ...
                    xx1++;
                        s = "待查看";
                    ht1+='<li data-id="" class="onlineResume"><label class="checkbox"><input type="checkbox"><i></i></label><div class="resumeShow"><a title="预览在线简历" target="_blank" class="resumeImg" href="preview?email='+obj[i].stuEmail+'"><img src="style/images/default_headpic.png"></a><div class="resumeIntro"><h3 class="unread"><a target="_blank" title="预览简历" href=""></a><em></em></h3><span class="fr">报名时间：'
                    ...
                    xx2++;
                        s = "已通过";
                        ht2+='<li data-id="1686182" class="onlineResume"><label class="checkbox"><input type="checkbox"><i></i></label><div class="resumeShow"><a title="预览在线简历" target="_blank" class="resumeImg" href="preview?email='+obj[i].stuEmail+'"><img src="style/images/default_headpic.png"></a><div class="resumeIntro"><h3 class="unread"><a target="_blank" title="预览简历" href=""></a><em></em></h3><span class="fr">报名时间：'
                                              +obj[i].applyTime+'</span><div>'
                                              +obj[i].name+'&nbsp;/&nbsp;'+obj[i].sex+'&nbsp;/&nbsp;'+obj[i].rank+'&nbsp;/&nbsp;'+obj[i].height+'&nbsp;/&nbsp;'+obj[i].weight+'<br>期望兼职·'+
                                               obj[i].exJob+'&nbsp;&nbsp;|&nbsp;&nbsp;空闲时间：'+obj[i].freeTime+
                                               '</div><div class="jdpublisher"><span>应聘职位：<a title="查看兼职信息" target="_blank" href="applyRe?id='+obj[i].applyId+'">'+
                    ...
                    xx3++;
                        s = "不合适";
                        ht3+='<li data-id="1686182" class="onlineResume"><label class="checkbox"><input type="checkbox"><i></i></label><div class="resumeShow"><a title="预览在线简历" target="_blank" class="resumeImg" href="preview?email='+obj[i].stuEmail+'"><img src="style/images/default_headpic.png"></a><div class="resumeIntro"><h3 class="unread"><a target="_blank" title="预览简历" href=""></a><em></em></h3><span class="fr">报名时间：'
                                              +obj[i].applyTime+'</span><div>'
                                              +obj[i].name+'&nbsp;/&nbsp;'+obj[i].sex+'&nbsp;/&nbsp;'+obj[i].rank+'&nbsp;/&nbsp;'+obj[i].height+'&nbsp;/&nbsp;'+obj[i].weight+'<br>期望兼职·'+
                                               obj[i].exJob+'&nbsp;&nbsp;|&nbsp;&nbsp;空闲时间：'+obj[i].freeTime+
                                               '</div><div class="jdpublisher"><span>应聘职位：<a title="查看兼职信息" target="_blank" href="applyRe?id='+obj[i].applyId+'">'+
                    	...
                    	<dl class="company_center_content">
        	                ...
        	                <dd>
        	                	...
        	                	<div class="publish_tip">
                                    ...
                                    <a onclick="lookRe()">查看兼职</a><br>
                                                                <a class="greylink" onclick="create()">发布新兼职</a><br>
                                        	...
                                        	<dl class="company_center_content">
                            	                ...
                            	                <dd>
                            	                	...
                            	                	<div class="publish_tip">
                                                        ...
                                                        <a onclick="lookRe()">查看兼职</a><br>
                                                                                    <a class="greylink" onclick="create()">继续发布新兼职</a><br>
                                                                                    <a class="greylink" href="comIndex"> 进入我的公司主页</a><br>
                                                    	<div style="float:left;" class="invite_share">
...
<script src="style/js/job7.min.js" type="text/javascript"></script>
